...
const Card = styled.div`
  ...
  border-left: 4px solid
    ${({ $nbaTeam, theme }) =>
      theme.colors.teams?.[$nbaTeam] || theme.colors.primary};
  cursor: pointer;
...
const TeamBadge = styled.span`
  padding: 4px 8px;
  background: ${({ $nbaTeam, theme }) =>
    theme.colors.teams?.[$nbaTeam] || theme.colors.primary}15;
  color: ${({ $nbaTeam, theme }) =>
    theme.colors.teams?.[$nbaTeam] || theme.colors.primary};
...
const PlayerCard = ({ player, selected = false, onClick }) => {
  ...
  return (
    <Card $nbaTeam={nbaTeam} $selected={selected} onClick={onClick}>
      ...
      <PlayerInfo>
        ...
        <PlayerMeta>
          <TeamBadge $nbaTeam={nbaTeam}>{nbaTeam}</TeamBadge>
